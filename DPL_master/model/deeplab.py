...
import torch
import numpy as np
from model.loss import SelfAdaptiveTrainingCE
...
class ResNet101(nn.Module):
    def __init__(self, block, layers, num_classes, phase):
        ...
        for m in self.modules():
            if isinstance(m, nn.Conv2d):
                ...
                #            i.requires_grad = False
        self.print_networks()
        self.adap_cretition = SelfAdaptiveTrainingCE()
    ...
    def print_networks(self):
        ...
        print('[Network %s] Total number of parameters : %.3f M' % ("deeplab", num_params / 1e6))
        print('-----------------------------------------------')
